...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheRewardPoliciesListGenerated.onTable(defaultTableId).iCheckColumns(undefined, {"channel":{"header":"channel"},"pointsPerCurrencyUnit":{"header":"pointsPerCurrencyUnit"}});
        });
