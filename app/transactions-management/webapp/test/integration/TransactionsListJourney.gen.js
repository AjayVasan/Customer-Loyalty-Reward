...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheTransactionsListGenerated.onTable(defaultTableId).iCheckColumns(undefined, {"txnDate":{"header":"txnDate"},"channel":{"header":"channel"},"amount":{"header":"amount"},"pointsEarned":{"header":"pointsEarned"}});
        });
