...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheCustomersListGenerated.onTable(defaultTableId).iCheckColumns(undefined, {"name":{"header":"name"},"email":{"header":"email"},"totalPoints":{"header":"totalPoints"},"lifetimePoints":{"header":"lifetimePoints"},"tier":{"header":"tier"}});
        });
